...
/* pin number (digitalWrite)      port         bit   pwm  icp comment */ \
  ...
  [ 5] = { (volatile uint32_t *) IO_LED,        7,   -1, -1 }, \
  [ 6] = { (volatile uint32_t *) IO_LED,        6,   -1, -1 }, \
  [ 7] = { (volatile uint32_t *) IO_LED,        5,   -1, -1 }, \
  ...
  [41] = { (volatile uint32_t *) IO_LED,        0,   -1,  0  /* icp0 */ }, \
  [42] = { (volatile uint32_t *) IO_LED,        1,    0, -1  /* ocp0 */ }, \
  [43] = { (volatile uint32_t *) IO_LED,        2,    1, -1  /* ocp1 */ }, \
  [44] = { (volatile uint32_t *) IO_LED,        3,   -1,  1  /* icp1 */ }, \
