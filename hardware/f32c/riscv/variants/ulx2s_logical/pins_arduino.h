...
/* arduino pin number               port         bit bitmask  pwm  icp comment */ \
  ...
  { /*  8 */  (volatile uint32_t *) IO_LED,        0, 1<<0,    -1,  0 /* led0, icp0 */ }, \
  { /*  9 */  (volatile uint32_t *) IO_LED,        1, 1<<1,     0, -1 /* led1, ocp0 */ }, \
  { /* 10 */  (volatile uint32_t *) IO_LED,        2, 1<<2,     1, -1 /* led2, ocp1 */ }, \
  { /* 11 */  (volatile uint32_t *) IO_LED,        3, 1<<3,    -1,  1 /* led3, icp1 */ }, \
  { /* 12 */  (volatile uint32_t *) IO_LED,        4, 1<<4,    -1, -1 /* led4 */ }, \
  { /* 13 */  (volatile uint32_t *) IO_LED,        5, 1<<5,    -1, -1 /* led5 */ }, \
  { /* 14 */  (volatile uint32_t *) IO_LED,        6, 1<<6,    -1, -1 /* led6, pwm0 */ }, \
  { /* 15 */  (volatile uint32_t *) IO_LED,        7, 1<<7,    -1, -1 /* led7, pwm1 */ }, \
