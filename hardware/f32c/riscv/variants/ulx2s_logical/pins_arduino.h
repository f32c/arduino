...
/* pin     port             bit   pwm       icp      */ \
  ...
  [16] = { PIN_TYPE_INPUT,   16,  OCP_NONE, ICP_NONE }, \
  [17] = { PIN_TYPE_INPUT,   17,  OCP_NONE, ICP_NONE }, \
  [18] = { PIN_TYPE_INPUT,   18,  OCP_NONE, ICP_NONE }, \
  [19] = { PIN_TYPE_INPUT,   19,  OCP_NONE, ICP_NONE }, \
  [20] = { PIN_TYPE_INPUT,   20,  OCP_NONE, ICP_NONE }, \
  [21] = { PIN_TYPE_INPUT,   21,  OCP_NONE, ICP_NONE }, \
  [22] = { PIN_TYPE_INPUT,   22,  OCP_NONE, ICP_NONE }, \
  [23] = { PIN_TYPE_INPUT,   23,  OCP_NONE, ICP_NONE }, \
  [24] = { PIN_TYPE_INPUT,   24,  OCP_NONE, ICP_NONE }, \
  [25] = { PIN_TYPE_INPUT,   25,  OCP_NONE, ICP_NONE }, \
  [26] = { PIN_TYPE_INPUT,   26,  OCP_NONE, ICP_NONE }, \
  [27] = { PIN_TYPE_INPUT,   27,  OCP_NONE, ICP_NONE }, \
  [28] = { PIN_TYPE_INPUT,   28,  OCP_NONE, ICP_NONE }, \
  [29] = { PIN_TYPE_INPUT,   29,  OCP_NONE, ICP_NONE }, \
  [30] = { PIN_TYPE_INPUT,   30,  OCP_NONE, ICP_NONE }, \
  [31] = { PIN_TYPE_INPUT,   31,  OCP_NONE, ICP_NONE }, \
