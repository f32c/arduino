...
#define	KBD_KEY_READY		0x8000			// new byte waiting
#define	KBD_READY_TO_SEND	0x4000			// ready to send byte
#define	KBD_SEND_ERROR		0x2000			// send timeout

extern int get_ps2_data();				// returns 0 for no code
extern bool send_ps2_data(uint8_t cmd);	// returns true if no error
...
class PS2Keyboard {
  public:
     ...
     */
    static bool begin(const PS2Keymap_t &map = PS2Keymap_US);
