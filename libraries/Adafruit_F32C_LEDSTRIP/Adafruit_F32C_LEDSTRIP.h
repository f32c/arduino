...
#define F32C_VGA_WIDTH  72
#define F32C_VGA_HEIGHT 50

/* vertically multiply height with the
repeated pattern to fill 480 lines so the
same code will work on both VGA and LEDSTRIP
useful to preview the image 
*/
#define F32C_VGA_HEIGHT_MULTIPLE 10

class Adafruit_F32C_LEDSTRIP : public Adafruit_GFX {
 public:
  Adafruit_F32C_LEDSTRIP(int8_t mode);
